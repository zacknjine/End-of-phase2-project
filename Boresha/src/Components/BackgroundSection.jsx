...
const BackgroundSection = () => {
  return (
    <div
      className="w-full h-screen pt-10 bg-cover bg-center"
    ...
    >
      <header className="text-white flex items-center justify-center h-full">
        <div className="text-center flex flex-col justify-center items-center px-4">
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-sans font-bold">Transparency is here!</h1>
          <p className="text-lg sm:text-xl md:text-3xl font-sans font-semibold pt-4">
